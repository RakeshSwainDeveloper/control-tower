...
export const routes: RouteObject[] = [
  ...
  /* ── Site (mobile-first) ───────────────────────────────────── */
  {
    ...
    children: [
      ...
      { path: 'progress/history',  element: screen(() => import('./screens/site/ProgressHistory.js'), 'ProgressHistory') },
      ...
      { path: 'issues',            element: screen(() => import('./screens/site/IssueList.js'), 'IssueList') },
      { path: 'issues/new',        element: screen(() => import('./screens/site/RaiseIssue.js'), 'RaiseIssue') },
      { path: 'issues/:issueId',   element: screen(() => import('./screens/site/IssueDetail.js'), 'IssueDetail') },
  ...
  /* ── Office ────────────────────────────────────────────────── */
  {
    ...
    children: [
      { index: true,                element: screen(() => import('./screens/office/Dashboard.js'), 'Dashboard') },
      { path: 'projects',           element: screen(() => import('./screens/office/Portfolio.js'), 'Portfolio') },
      ...
      { path: 'issues',             element: screen(() => import('./screens/office/IssueRegister.js'), 'IssueRegister') },
      { path: 'issues/:issueId',    element: screen(() => import('./screens/site/IssueDetail.js'), 'IssueDetail') },
      ...
      { path: 'audit',              element: screen(() => import('./screens/office/Audit.js'), 'Audit') },
    ],
  },
